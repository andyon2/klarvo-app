...
green after the last revert (`cargo test --lib` 748 passed; JVM gate 25 suites / 214
tests / 0 failures).
...
| 7 | save_advanced_settings stops rebuilding the STT slot | `src-tauri/src/commands/settings.rs` | `spec_test_provider_stt_change_rebuilds_the_stt_provider` | **RED** ✓ |
