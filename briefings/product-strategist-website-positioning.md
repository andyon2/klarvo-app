...
3. **Timing:** Jetzt zeigen mit Status-Label, nicht auf perfekten Launch warten

4. **Risiko:** Bei Freelance kein Problem. Bei Teilzeit: "bestehendes Projekt" framen, nicht "laufendes Startup"
...
- **Lizenz:** BSL 1.1 (source-available, NICHT Open Source)
- **Preis:** EUR 29 Einmalkauf (geplant)
...
- Sucht Teilzeit (kein Vollzeit-Startup-Gruender-Image)
- Technisch versiert (Rust, TypeScript, Mobile)
- Hands-on: baut selbst statt nur zu beraten
