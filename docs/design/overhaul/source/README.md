...
## Surfaces (Desktop) — in `Klarvo Design System.html` (Abschnitte FloatingBar, App, Live-Preview)
...
## Surface (Android) — in `Klarvo Design System.html` (Abschnitt Android)
...
## Files
- `Klarvo Design System.html` — **Single Source of Truth.** Ein Dokument mit allem: Kritik, Direction, Tokens, Desktop-Flächen (FloatingBar, Settings, Live-Preview, History) und Android (Bubble-States, Listening-Panel, Long-Press-Menü, Tastatur-Einklappen) sowie Umsetzungshinweise/Machbarkeit für beide Plattformen.
