...
5. Pruefe `dispatches/inbox/` -- Dateien vorhanden? Sofort integrieren (Regel in CLAUDE.md aufnehmen, Knowledge aktualisieren, etc.), Datei nach `dispatches/archive/` verschieben, Zeile in `dispatches/log.md` ergaenzen. Im Briefing nur berichten was integriert wurde.
