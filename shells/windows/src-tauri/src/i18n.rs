...
/// Phase-1: locale is loaded once at boot from ShellConfig (currently hardcoded `en`; Story 4.2
/// adds `load(ui_language)` that replaces this function).
...
mod tests {
    ...
    //
    // Audit source: i18n-coverage-audit-2026-04-25.md
    // Note: story spec used `error.stt.upstream_unavailable`; actual Groq plugin emits
