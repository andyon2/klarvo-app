...
mod tests {
    ...
    fn test_settings_view_camel_case_serialization() {
        let view = SettingsView {
            ...
            preview_text_color: "rgba(236,238,239,0.95)".to_string(),
            preview_bg_color: "rgba(22,24,26,0.96)".to_string(),
            preview_bg_blur: 12,
            preview_border_color: "rgba(41,199,172,0.25)".to_string(),
            preview_border_width: 1,
            preview_border_radius: 14,
            preview_font_family: "'Geist Mono', ui-monospace, 'Cascadia Code', monospace".to_string(),
