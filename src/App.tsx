    ...
    <button
      ...
      className={[
        ...
        isRecording
          ...
          : isBusy
          ? "bg-klarvo-amber/15 text-klarvo-amber shadow-[0_0_30px_var(--glow-amber)]"
          : "bg-klarvo-teal/15 text-klarvo-teal shadow-[0_0_40px_var(--glow-teal)] hover:shadow-[0_0_50px_var(--glow-teal-hover)] hover:bg-klarvo-teal/20",
      ].join(" ")}
    >
      <span
        className={[
                    ...
                    <div className="flex items-center justify-between mt-2">
                      <span className="text-[11px] text-klarvo-dim">
                        ...
                        {entry.style !== "polished" && (
                          <span className="text-klarvo-teal"> · {entry.style}</span>
                        )}
                        {entry.appName && (
                          <span className="ml-1 px-1.5 py-0.5 bg-klarvo-amber/10 rounded-full text-[9px] text-klarvo-amber">{entry.appName}</span>
                        )}
                      </span>
                      <div className="flex gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <button
                          ...
                          className="text-[11px] text-klarvo-danger hover:text-klarvo-danger-hi transition-colors"
                        >
                          Delete
                        </button>
                      </div>
