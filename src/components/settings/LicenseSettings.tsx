    ...
    <div className="flex flex-col gap-1">
      <button
        ...
        className={[
          ...
          confirmRemove ? "text-klarvo-danger hover:text-klarvo-danger" : "text-klarvo-amber/80 hover:text-klarvo-amber",
        ].join(" ")}
      >
      ...
      {licenseSource === "lemon_squeezy" && (
        <button
          ...
          className={[
            "self-start transition-colors disabled:opacity-40",
            isMobile ? "text-sm" : "text-[11px]",
            confirmDeactivate ? "text-klarvo-danger hover:text-klarvo-danger" : "text-klarvo-amber/80 hover:text-klarvo-amber",
          ].join(" ")}
        >
